<div class="header">
    <h1>Edit <?php echo htmlentities($recBillType->name()); ?> Bill</h1>
</div>
...
<nav class="breadcrumbs">
    <ul>
        ...
        <li><a href="/address/<?php echo htmlentities($recAddress->id()); ?>/bill-type/<?php echo htmlentities($recBillType->id()); ?>/bill"><?php echo htmlentities($recBillType->name()); ?> Bills</a></li>
        <li>Edit: <?php echo htmlentities($recBill->bill_date()); ?></li>
    </ul>
</nav>

<div class="content">
    <form method="post" action="" id="frm" class="form-group main-form">
        <input type="hidden" id="bill.id" name="bill.id" value="<?php echo htmlentities($recBill->id()); ?>" />
        ...
        <div class="button-group">
            ...
            <a href="/address/<?php echo htmlentities($recAddress->id()); ?>/bill-type/<?php echo htmlentities($recBillType->id()); ?>/bill/<?php echo htmlentities($recBill->id()); ?>/delete" class="button remove"><i class="fa-solid fa-trash"></i>Delete?</a>
        </div>
    </form>
</div>